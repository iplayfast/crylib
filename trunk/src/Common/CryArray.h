...
template<typename T>
class CryTArray : public CrySimpleArray
{
	T *Values;
	//int Size;
	// not used
...
class CryIntegerArray : public CryTArray<int>
{
public:
